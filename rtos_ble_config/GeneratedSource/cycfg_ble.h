...
#define CY_BLE_CONFIG_CUSTOMS_SERVICE_CHAR_DESCRIPTORS_COUNT   (0x03u)
...
#define CY_BLE_CUSTOM_SERVICE_CUSTOM_CHARACTERISTIC_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */

#define CY_BLE_CUSTOM_NOTIFICATION_SERVICE_INDEX   (0x01u) /* Index of Custom Notification service in the cy_ble_customSServ array */
#define CY_BLE_CUSTOM_NOTIFICATION_CUSTOM_CHARACTERISTIC_CHAR_INDEX   (0x00u) /* Index of Custom Characteristic characteristic */
#define CY_BLE_CUSTOM_NOTIFICATION_CUSTOM_CHARACTERISTIC_CUSTOM_DESCRIPTOR_DESC_INDEX   (0x00u) /* Index of Custom Descriptor descriptor */
#define CY_BLE_CUSTOM_NOTIFICATION_CUSTOM_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x01u) /* Index of Client Characteristic Configuration descriptor */

#define CY_BLE_CUSTOM_SERVICE_SERVICE_HANDLE   (0x0010u) /* Handle of Custom Service service */
#define CY_BLE_CUSTOM_SERVICE_CUSTOM_CHARACTERISTIC_DECL_HANDLE   (0x0011u) /* Handle of Custom Characteristic characteristic declaration */
#define CY_BLE_CUSTOM_SERVICE_CUSTOM_CHARACTERISTIC_CHAR_HANDLE   (0x0012u) /* Handle of Custom Characteristic characteristic */
#define CY_BLE_CUSTOM_SERVICE_CUSTOM_CHARACTERISTIC_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0013u) /* Handle of Custom Descriptor descriptor */

#define CY_BLE_CUSTOM_NOTIFICATION_SERVICE_HANDLE   (0x0014u) /* Handle of Custom Notification service */
#define CY_BLE_CUSTOM_NOTIFICATION_CUSTOM_CHARACTERISTIC_DECL_HANDLE   (0x0015u) /* Handle of Custom Characteristic characteristic declaration */
#define CY_BLE_CUSTOM_NOTIFICATION_CUSTOM_CHARACTERISTIC_CHAR_HANDLE   (0x0016u) /* Handle of Custom Characteristic characteristic */
#define CY_BLE_CUSTOM_NOTIFICATION_CUSTOM_CHARACTERISTIC_CUSTOM_DESCRIPTOR_DESC_HANDLE   (0x0017u) /* Handle of Custom Descriptor descriptor */
#define CY_BLE_CUSTOM_NOTIFICATION_CUSTOM_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0018u) /* Handle of Client Characteristic Configuration descriptor */
            ...
            <ProfileRoles>
                <ProfileRole type="Server">
                    ...
                    <Services>
                        <Service type="org.bluetooth.service.generic_access">
                            <ServiceProperties>
                                <Property id="EntityID" value="{abb8f175-0fb8-4d4a-8eb9-249fba407ae1}"/>
                                    ...
                                    <Fields>
                                        <Field>
                                            <FieldProperties>
                                                ...
                                                <Property id="EnumValue" value="192"/>
                                    ...
                                    <Fields>
                                        <Field>
                                            <FieldProperties>
                                                ...
                                                <Property id="Value" value="0x0006"/>
                                        ...
                                        <Field>
                                            <FieldProperties>
                                                ...
                                                <Property id="Value" value="0x0028"/>
                                                <Property id="Format" value="f_uint16"/>
                                            </FieldProperties>
                                        </Field>
                                        <Field>
                                        ...
                                        <Field>
                                            <FieldProperties>
                                                ...
                                                <Property id="Value" value="0x03E8"/>
                                                <Property id="Format" value="f_uint16"/>
                                            </FieldProperties>
                                        </Field>
                                    </Fields>
                        ...
                        <Service type="org.bluetooth.service.generic_attribute">
                            <ServiceProperties>
                                <Property id="EntityID" value="{9950e7a2-5e43-4157-b8f8-6245825cf6d6}"/>
                        ...
                        <Service type="org.bluetooth.service.custom">
                            <ServiceProperties>
                                <Property id="EntityID" value="{7243a740-a22b-4715-ba03-fb0effc35d07}"/>
                                <Property id="Name" value="Custom Service"/>
                            ...
                            <Characteristics>
                                <Characteristic type="org.bluetooth.characteristic.custom">
                                    <CharacteristicProperties>
                                        <Property id="Name" value="Custom Characteristic"/>
                                    ...
                                    <Descriptors>
                                        <Descriptor type="org.bluetooth.descriptor.custom">
                                            <DescriptorProperties>
                                                <Property id="Name" value="Custom Descriptor"/>
                                                <Property id="DisplayName" value="Custom Descriptor"/>
                                                <Property id="UUID" value="C6F8C292-A848-44E4-8D7A-2B215DD9B57C"/>
                                            </DescriptorProperties>
                                            <Fields>
                                                <Field>
                                                    <FieldProperties>
                                                        <Property id="Name" value="User Descriptor"/>
                                                        <Property id="Value" value="BLE_Custom_User_Descriptor"/>
                                                        <Property id="Format" value="f_utf8s"/>
                        ...
                        <Service type="org.bluetooth.service.custom">
                            <ServiceProperties>
                                <Property id="EntityID" value="{8fa3b364-6bd5-4721-8eb4-70c8a0c29131}"/>
                                <Property id="Name" value="Custom Service"/>
                                <Property id="DisplayName" value="Custom Notification"/>
                                <Property id="UUID" value="CCCC"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
                                <Property id="IncludedServices" value=""/>
                            </ServiceProperties>
                            <Characteristics>
                                    ...
                                    <Descriptors>
                                        <Descriptor type="org.bluetooth.descriptor.custom">
                                            <DescriptorProperties>
                                                <Property id="Name" value="Custom Descriptor"/>
                                                <Property id="DisplayName" value="Custom Descriptor"/>
                                                <Property id="UUID" value="1A4CF734-54E2-4D76-9E3D-A73E7D96BF26"/>
                                            </DescriptorProperties>
                                            <Fields>
                                                <Field>
                                                    <FieldProperties>
                ...
                <ProfileRole type="Client">
                    ...
                    <Services>
                        <Service type="org.bluetooth.service.generic_access">
                            <ServiceProperties>
                                <Property id="EntityID" value="{68ca3f2e-078e-4992-b49c-fe500bd935b8}"/>
                                <Property id="Name" value="Generic Access"/>
                                <Property id="DisplayName" value="Generic Access"/>
                                <Property id="UUID" value="1800"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
                        ...
                        <Service type="org.bluetooth.service.generic_attribute">
                            <ServiceProperties>
                                <Property id="EntityID" value="{0389d9ba-a363-49ee-8525-aed9abc851e3}"/>
                                <Property id="Name" value="Generic Attribute"/>
                                <Property id="DisplayName" value="Generic Attribute"/>
                                <Property id="UUID" value="1801"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
        ...
        <PeripheralConfigurations>
            <PeripheralConfiguration name="Peripheral configuration 0">
                <AdvertisementProperties>
                    ...
                    <Property id="AdvReducedScanIntervalMin" value="1000.0000000000001"/>
                ...
                <AdvertisementPacket>
                    ...
                    <Property id="ServiceUuid" value=""/>
                    <Property id="AdServiceSolicitation" value="true"/>
                    <Property id="ServiceSolicitation0" value="aaaa"/>
                    <Property id="ServiceSolicitation1" value=""/>
                    <Property id="ServiceSolicitation2" value=""/>
                    <Property id="ServiceSolicitation3" value=""/>
                    <Property id="ServiceSolicitation4" value=""/>
                    <Property id="ServiceSolicitation5" value=""/>
