...
cy_stc_smif_mem_cmd_t CY15B104Qx_SlaveSlot_0_readCmd =
{
...
cy_stc_smif_mem_cmd_t CY15B104Qx_SlaveSlot_0_writeEnCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x06U,
    /* The width of the command transfer. */
...
cy_stc_smif_mem_cmd_t CY15B104Qx_SlaveSlot_0_writeDisCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x04U,
    /* The width of the command transfer. */
...
cy_stc_smif_mem_cmd_t CY15B104Qx_SlaveSlot_0_programCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x02U,
    /* The width of the command transfer. */
...
cy_stc_smif_mem_cmd_t CY15B104Qx_SlaveSlot_0_readStsRegWipCmd =
{
    /* The 8-bit command. 1 x I/O read command. */
    .command = 0x05U,
    /* The width of the command transfer. */
...
cy_stc_smif_mem_device_cfg_t deviceCfg_CY15B104Qx_SlaveSlot_0 =
{
    ...
    .readCmd = &CY15B104Qx_SlaveSlot_0_readCmd,
    /* Specifies the Write Enable command. */
    .writeEnCmd = &CY15B104Qx_SlaveSlot_0_writeEnCmd,
    /* Specifies the Write Disable command. */
    .writeDisCmd = &CY15B104Qx_SlaveSlot_0_writeDisCmd,
    ...
    .programCmd = &CY15B104Qx_SlaveSlot_0_programCmd,
    ...
    .readStsRegWipCmd = &CY15B104Qx_SlaveSlot_0_readStsRegWipCmd,
...
const cy_stc_smif_mem_config_t CY15B104Qx_SlaveSlot_0 =
{
    ...
    .deviceCfg = &deviceCfg_CY15B104Qx_SlaveSlot_0
};

const cy_stc_smif_mem_config_t* smifMemConfigs[] = {
   &CY15B104Qx_SlaveSlot_0
};
